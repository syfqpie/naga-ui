 ...
 * </naga-button> ```
 */
let NagaButton = class NagaButton extends LitElement {
  constructor() {
    super(...arguments);
    this.size = 'md';
    this.isFull = false;
...
__decorate([property({
  type: String
})], NagaButton.prototype, "size", void 0);
__decorate([property({
  type: Boolean
})], NagaButton.prototype, "isFull", void 0);
__decorate([property({
  type: Boolean
})], NagaButton.prototype, "disabled", void 0);
__decorate([property({
  attribute: false
})], NagaButton.prototype, "onClick", void 0);
NagaButton = __decorate([customElement('naga-button')], NagaButton);
