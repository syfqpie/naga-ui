...
const style = css`
	:host {
		...
		--naga-success-bg-hovered: rgba(22, 163, 74, 0.7); /** #16A34A */
		--naga-success-bg-focused: rgba(22, 163, 74, 0.9); /** #16A34A */
		...
		--naga-error-bg-hovered: rgba(220, 38, 38, 0.7); /** #DC2626 */
		--naga-error-bg-focused: rgba(220, 38, 38, 0.9); /** #DC2626 */
